window.onload = function (){
        ...
        setInterval(game, 100)//intervalo de chamada da funçao game()
        ...
        var tamP = 10 //tamanho de cada quadrado
        var qtdP = 40  //qtd de peças
        ...
        function game(){
            ...
            if(ax==px && ay==py){//se acertar a maça
                calda++
                pnt++
                ax= Math.floor(Math.random()*qtdP)//altera a posiçao da maça
                ay= Math.floor(Math.random()*qtdP)
            }
